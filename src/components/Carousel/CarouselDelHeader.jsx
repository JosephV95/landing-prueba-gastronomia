    ...
    >
      <div className="h-full w-full  bg-[url('../img/slide/slide-1.jpg')] bg-cover bg-top " id="inicio"> 
        <div className="h-full w-full absolute bg-black/50 backdrop-brightness-110 flex justify-center">
          <CallToAction 
          tituloEnHTML={<h2 data-aos="fade-down" data-aos-duration="500" data-aos-easing="linear" className="text-2xl sm:text-3xl md:text-4xl font-Kalam font-bold" ><span className="text-orange-500">Delicious</span> Restaurante</h2>}  
